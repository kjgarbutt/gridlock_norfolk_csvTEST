package sim.app.geo.gridlock_norfolk_csvTEST;
...
public class NorfolkCSVTEST extends SimState	{
    ...
    public NorfolkCSVTEST(long seed)	{
        ...
        try	{
            ...
            URL floodGeometry = NorfolkCSVTEST.class.getResource("data/flood_zone_3_010k_NORFOLK_ONLY.shp");
            ...
            //URL roadGeometry = NorfolkCSV.class.getResource("/Users/KJGarbutt/Desktop/Untitled.shp");
    ...
    void addNGOAgents()	{
    	...
    	//for (int i = 0; i < numAgents; i++)
		try {
			reader1 = new CSVReader(new FileReader(filename1), ',', '"', 1);
			String [] nextLine;
